...
export { isPrintable } from './lib/is-printable';
export { isRegex } from './lib/is-regex';
export { isSameSize } from './lib/is-same-size';
export { isSized } from './lib/is-sized';
export { isString } from './lib/is-string';
export { isUndefined } from './lib/is-undefined';
export { isWhitespace } from './lib/is-whitespace';
